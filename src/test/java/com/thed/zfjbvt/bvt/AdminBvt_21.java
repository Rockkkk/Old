...
public class AdminBvt_21 extends BaseTest {
	...
	public void testBvt10(){
		...
		isSuccess = true;
		logger.info("Tests with test step created successfully.");
...
public void testBvt29() {
	...
	public void testBvt39(){
		...
		values.put("PROJECT_NAME", "ZFJ");	// Name of the project
		values.put("VERSION_NAME", "Version 1.0");	// Name of the version
		values.put("CYCLE_NAME", "Cycle One");	// Name of the cycle.
		values.put("TEST_ONE", "ZFJ-14");	// Name of the testcase one.
		values.put("TEST_TWO", "ZFJ-2");	// Name of the testcase two.
	...
	public void testBvt40(){
		...
		isSuccess=zfjNavigator.changeBulkTestsStatus("fail",3);
	...
	public void  testBvt41(){
		...
		isSuccess=zfjNavigator.changeBulkTestsStatusWithTeststeps("cancel", "fail", 2);
	...
	public void testBvt47(){
		...
		logger.info("Bvt 47 executed successfully...");
	}
	@Test(enabled=testEnabled, priority=48)
	public void testBvt48(){
		altID=48;
		logger.info("executing bvt 48...");
		Map<String, String> values= new HashMap<String, String>();
		values.put("FILTER_NAME_ONE", "My Executed Tests");	// Name of the filter.
		values.put("FILTER_NAME_TWO", "All Unexecuted Tests");	// Name of the filter.
		values.put("PROJECT_NAME", "ZFJ");	// Name of the project.
		values.put("VERSION_NAME", "Version 1.0");	// Name of the version.
		values.put("CYCLE_NAME", "Cycle One");	//	Name of the cycle.
		values.put("TEST_NAME", testKeySet.get("Fourth test for execute test status"));	// Name of the test.
		values.put("TEST_EXEC_STATUS", "WIP");	// Name of the status to be execute.
		...
		logger.info("Bvt 48 executed successfully...");
	}
	@Test(enabled=testEnabled, priority=49)
	public void testBvt49(){
		altID=49;
		logger.info("executing bvt 49...");
		Map<String, String> values= new HashMap<String, String>();
		values.put("FILTER_NAME_ONE", "My Executed Tests");
		values.put("FILTER_NAME_TWO", "All Unexecuted Tests");
		values.put("PROJECT_NAME", "ZFJ");
		values.put("VERSION_NAME", "Version 1.0");	// Version is used for selecting the version in jira.
		values.put("CYCLE_NAME", "Cycle One");	//	Here cycle is used for selecting a cycle in zfj.
		...
		logger.info("Bvt 49 executed successfully...");
	}
	
	@Test(enabled=testEnabled, priority=50)
	public void testBvt50(){
		altID=50;
		logger.info("executing bvt 50...");
		Map<String, String> values= new HashMap<String, String>();
		...
		logger.info("Bvt 50 executed successfully...");
	}
	...
	public void testBvt82(){
		...
		logger.info("Bvt 82 executed successfully...");
	...
	public void testBvt83(){
		...
		logger.info("Bvt 83 executed successfully...");
	...
	public void testBvt84(){
		...
		isSuccess = zfjNavigator.validateRemoteIssueLink(values);
		Assert.assertTrue(isSuccess, "Validating IssueLink Failed... ");
		logger.info("Bvt 84 executed successfully...");
