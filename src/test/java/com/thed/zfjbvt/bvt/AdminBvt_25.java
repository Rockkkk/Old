...
public class AdminBvt_25 extends BaseTest {
	...
	public void testBvt8(){
		...
		values.put("PRIORITY", Config.getValue("PRIORITY_ONE")); // priority of new Test.
	...
	public void testBvt15(){
		...
		values.put("CHANGE_PRIORITY_TO", Config.getValue("PRIORITY_THREE"));
	...
	public void testBvt17(){
		...
		values.put("SECOND_PRIORITY", Config.getValue("PRIORITY_THREE"));
	...
	public void testBvt18(){
		...
		values.put("TEST_PRIORITY", Config.getValue("PRIORITY_THREE")); // priority of new Test.
		...
		values.put("TEST_PRIORITY", Config.getValue("PRIORITY_FIVE"));
		...
		values.put("TEST_PRIORITY", "Highest");
	...
	public void testBvt23() {
		...
		values.put("PRIORITY", Config.getValue("PRIORITY_ONE"));	// The priority value which will need while creating atest.
...
@Test(enabled = testEnabled, priority=31)
	...
	public void testBvt36(){
		...
		values.put("TEST_PRIORITY", Config.getValue("PRIORITY_ONE")); // priority of new Test.
	...
	public void testBvt94(){
		...
		values.put("PRIORITY", Config.getValue("PRIORITY_ONE")); // priority of first Test.
		...
		values.put("PRIORITY", Config.getValue("PRIORITY_ONE")); // priority of second Test.
