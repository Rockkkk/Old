...
public class JiraAdminManageAddonsPage {
	 ...
	 *****************************************************/
		...
		@FindBy(xpath="//div[@id='upm-plugin-status-dialog']/descendant::*[text()='Close']")
		...
		public boolean uploadAddons(){
			try{
				...
				Assert.assertTrue(CommonUtil.visibilityOfElementLocated("//*[@id='upm-manage-container-user-installed']"), "Waiting for User Installed Plug-in.");
