...
public class LoginPage {
	...
	public boolean login(String userName, String password){
		try{
			...
			CommonUtil.highlightElement(usernameEditbox);
			usernameEditbox.clear();
			usernameEditbox.sendKeys(userName);
			CommonUtil.javaWait(Constants.JAVA_WAIT_LOW);
			CommonUtil.highlightElement(passwordEditbox);
			passwordEditbox.clear();
			passwordEditbox.sendKeys(password);
			CommonUtil.javaWait(Constants.JAVA_WAIT_LOW);
			CommonUtil.highlightElement(loginButton);
			loginButton.click();
