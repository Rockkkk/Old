...
public class JiraAdminFindNewAddonsPage {
	...
	public boolean findNewAddons(String searchText){
		try{
			...
			Assert.assertTrue(CommonUtil.scrollPage(CommonUtil.changeToWebElement("//div[@id='upm-panel-install']//*[contains(@id,'upm-plugin')]/descendant::*[@class='upm-plugin-vendor']")), "Page is not scrolled to the plugin table.");
