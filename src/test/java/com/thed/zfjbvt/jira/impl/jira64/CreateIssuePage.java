...
public class CreateIssuePage {
	...
	@FindBy(xpath= "//*[@id='qf-field-picker-trigger']/span[text()='Configure Fields ']")
	...
	//xpath to get the Test id created.(//div[@class='aui-message success closeable']/a)
	@FindBy(xpath="//div[contains(@class,'aui-message-success')]/a")
	private WebElement fetchId;
	
	//xpath to close the created issue pop-up.(//div[@class='aui-message success closeable']/span[2])
	@FindBy(xpath="//div[contains(@class,'aui-message-success')]//span[contains(@class, 'icon-close')]")
