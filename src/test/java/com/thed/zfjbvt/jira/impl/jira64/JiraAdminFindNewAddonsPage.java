...
public class JiraAdminFindNewAddonsPage {
	...
	@FindBy(xpath="//div[@id='upm-panel-install']//*[contains(@id,'upm-plugin')]/descendant:: *[@class='upm-plugin-name']")
	private List<WebElement> pluginNames;
	...
	public boolean findNewAddons(String searchText){
		try{
			...
			CommonUtil.visibilityOfElementLocated("//div[@id='upm-panel-install']//*[contains(@id,'upm-plugin')]/descendant::*[@class='upm-plugin-name']");
			...
			//Xpath Changed from //div[@id='upm-panel-install']/descendant::div[@class='upm-plugin']/descendant::*[@class='upm-plugin-vendor'] to //div[@id='upm-panel-install']//*[contains(@id,'upm-plugin')]/descendant::*[@class='upm-plugin-vendor']
			CommonUtil.presenceOfAllElementsLocatedBy("//div[@id='upm-panel-install']//*[contains(@id,'upm-plugin')]/descendant::*[@class='upm-plugin-vendor']");
			logger.info("New plugin is searched successfully");
			CommonUtil.javaWait(Constants.JAVA_WAIT_MEDIUM);
			
			Assert.assertTrue(CommonUtil.scrollPage(CommonUtil.changeToWebElement("//div[@id='upm-panel-install']//*[contains(@id,'upm-plugin')]/descendant:: *[@class='upm-plugin-name']")), "Page is not scrolled to the plugin table.");
