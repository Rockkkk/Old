...
public class JiraAdminManageAddonsPage {
	 ...
	 *****************************************************/
		...
		@FindBy(xpath="//*[@class='upm-plugin-installed-version-label']/following-sibling::*[contains(@class,'upm-plugin-installed-version')]")
		...
		@FindBy(xpath="//*[text()='License key:']/following-sibling::div/input[@name='submit']")
		private WebElement updateLicenceBtn;
		
		@FindBy(xpath="//div[@class='upm-license-details']//*[text()='License status:']/following-sibling::div")
		...
		@FindBy(xpath="//div[@class='upm-plugin-license-container']/descendant::*[text()='License key:']/following-sibling::*/a[@title='Edit']")
		private WebElement licenseKeyEditLink;
		
		@FindBy(xpath="//*[text()='License key:']/following-sibling::div/a[text()='Cancel']")
		...
		public boolean uploadAddons(){
			try{
				...
				if(CommonUtil.isElementPresent("//*[@id='upm-plugin-status-dialog']/descendant::h2[text()='Installed and ready to go!']")){
					...
					CommonUtil.clickOnElement("//*[@class='upm-plugin-name' and text()='Zephyr for JIRA']");
				}
				...
				if(CommonUtil.isElementPresent("//button[text()='Manage License']")){
					...
					if(CommonUtil.isElementPresent("//div[@id='upm-plugin-status-dialog']/descendant::a[text()='Close']")){
						pluginCloseLink.click();
						CommonUtil.implicitWait(Constants.IMPLICIT_WAIT_LOW);
					}					
					if(CommonUtil.getTextFromUIByXpath("//div[@class='upm-plugin-license-container']//*[text()='License details:']/following-sibling::div[contains(@class,'upm-plugin-license-info')]").equals("Unlicensed")){
						CommonUtil.javaWait(Constants.JAVA_WAIT_LOW);
						xpathForLicenceTextArea.clear();
						xpathForLicenceTextArea.sendKeys(Config.getValue("ZFJ_LICENSE"));
