...
import com.thed.zfjbvt.zfj.impl.zfj22.SearchTestsPage;
import com.thed.zfjbvt.zfj.impl.zfj22.TestMetricsPage;
import com.thed.zfjbvt.zfj.impl.zfj22.ExecuteTestsPage;
import com.thed.zfjbvt.zfj.impl.zfj22.PlanTestCyclePage;
import com.thed.zfjbvt.zfj.impl.zfj22.SearchTestExecutionsPage;
...
import com.thed.zfjbvt.zfj.impl.zfj22.ZephyrTestMenuPage;
import com.thed.zfjbvt.zfj.impl.zfj22.ZfjGeneralConfigPage;

public class ZfjNavigator22Impl implements ZfjNavigator{
...
*/		}catch(Exception e){
	...
	public boolean editTeststeps(Map<String, String> values){
		try{
			Assert.assertTrue(getZephyrTestMenuPage().navigateToSearchTestsPage().navigateToFirstTest().editTeststep(values));
	...
	public boolean editTestDetails(Map<String, String> values){
		try{
			/*Assert.assertTrue(getZephyrTestMenuPage().navigateToCreateTestPage().createTest(values)
					.validateTestCreated(values),"New Test Creation Failed...");*/
			Assert.assertTrue(getZephyrTestMenuPage().navigateToSearchTestsPage().navigateToFirstTest().navigateToEditTestPage(values).editTest(values));
	...
	public boolean cloneTestCycle(Map<String, String> values){
		try{
			...
			Assert.assertTrue(getZephyrTestMenuPage().navigateToPlanTestCyclePage().navigateToCloneTestCyclePage(values.get("VERSION_NAME"), values.get("CYCLE_NAME")).cloneTestCycle(values),"Test Cycle Cloning Failed...");
			Assert.assertTrue(PlanTestCyclePage.getInstance().verifyAddedTestsInCycle(values.get("CLONE_CYCLE_NAME"), testId),"Not the same Test added...");
			*/
