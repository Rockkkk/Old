...
/**
 * This is zfj's Execute Test's page, what user sees while try to execute the tests.
 * @author Manoj
 *
 */
public class ExecuteTestsPage {
	 ...
	 *****************************************************/
		...
		@FindBy(xpath="//div[label[@for='defects']]//dl//a")
		...
		public boolean executeTest(String status){
			try{
				...
				CommonUtil.javaWait(Constants.JAVA_WAIT_HIGH);
				System.out.println(currentDefectPicker.getText());
