...
import com.thed.zfjbvt.zfj.impl.zfj21.AddTestsToCyclePage;
import com.thed.zfjbvt.zfj.impl.zfj21.CloneTestCyclePage;
import com.thed.zfjbvt.zfj.impl.zfj21.CreateNewCyclePage;
...
private Logger logger = Logger.getLogger(this.getClass());
	...
	private boolean checkCycleIsExpanded(String cycleName){
		...
		try{
			String xpathForCycle="//li[div[div[label[text()='"+cycleName+"']]]]";
				  ...
				  if(CommonUtil.isElementPresent(planTestCycleHeaderTextXpath)){
					   for (int i=0; i<xpathForCycles.size() ; i++) {
						  ...
						  if(xpathForCycles.get(i).getAttribute("class").trim().equalsIgnoreCase("expando")){
							  ...
							  String xpathForCycleForClick="//ul[@id='project-panel-cycle-list-summary']/li["+(i+1)+"]/div/div[label[@class='versionBanner-name singleLine']]";
