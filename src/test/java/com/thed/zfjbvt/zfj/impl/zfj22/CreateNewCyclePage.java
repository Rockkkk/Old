...
import com.thed.zfjbvt.zfj.impl.zfj22.CalenderPopupPage;
...
private Logger logger = Logger.getLogger(this.getClass());
	...
	@FindBy(xpath="//*[@id='create-cycle-dialog']/descendant::h2")
	private WebElement createNewCycleHeadingText;
	
	// Create new cycle header text.
	@FindBy(xpath="//div[@id='edit-cycle-dialog']/descendant::h2")
