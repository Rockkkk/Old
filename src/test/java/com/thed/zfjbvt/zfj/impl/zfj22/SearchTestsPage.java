...
public class SearchTestsPage {
	...
	public boolean deleteTest(String testName) { 
        try {
           ...
           // CommonUtil.implicitWait(Constants.IMPLICIT_WAIT_MEDIUM);
            ...
            logger.info( CommonUtil.getTextFromUIByXpath("//div[@class='aui-message success closeable']") );
	...
	/*public boolean deleteAllFilters(){
		try{
			List<WebElement> listOfElements = CommonUtil.returnWebElementsFromXpath(".//*[@id='navigator-sidebar']/descendant::ul[@class='saved-filter filter-list favourite-filters']/li");
			for(int i=1; i<=listOfElements.size();i++){
				CommonUtil.actionClass().moveToElement(CommonUtil.returnWebElement(".//*[@id='navigator-sidebar']/descendant::ul[@class='saved-filter filter-list favourite-filters']/li["+i+"]")).perform();
				String actions = "//*[@id='navigator-sidebar']/descendant::ul[@class='saved-filter filter-list favourite-filters']/li["+i+"]/a[@class='filter-actions']";
				CommonUtil.navigateThroughXpath(actions);
				CommonUtil.javaWait(Constants.JAVA_WAIT_LOW);
				CommonUtil.navigateThroughXpath("//a[@class='aui-list-item-link delete-filter']");
				CommonUtil.visibilityOfElementLocated(".//*[@id='delete-filter-dialog']");
