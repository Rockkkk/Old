...
public class ZFJAdminCustomizeTestStatusPage {
	...
	public boolean updateTestExecutionStatus(String oldTestStatus, String newTestStatus, String newTestDescription){
		try{
			Assert.assertTrue(headerForTestExecutionStatusPageXpath.getText().equals("View Test Execution Statuses"), "This is not zfj Admin customize test status page.");
			logger.info("zfj admin customize test status page is verified successfully.");
			...
			Assert.assertTrue(CommonUtil.searchTheTextInList(allTestExecutionStatuses, oldTestStatus), "zfj test execution status is not present in all test execution status list");
			logger.info("zfj test execution status ia present inside all test execution status.");
				
			String xpathForMainTestExecutionStatusEditButton="//td[contains(text(),'"+oldTestStatus+"')]/following-sibling::td/descendant::a[contains(text(),'Edit')]";
			CommonUtil.navigateThroughXpath(xpathForMainTestExecutionStatusEditButton);
			CommonUtil.implicitWait(Constants.IMPLICIT_WAIT_MEDIUM);
			...
			Assert.assertTrue(CommonUtil.searchTheTextInList(allTestExecutionStatuses, newTestStatus), "zfj test execution status is not present in all test execution status list");
			logger.info("zfj test execution status ia present inside all test execution status.");
